...
public abstract class View {
	...
	public static void setMaximize(boolean b) {
		maximize = b;
	}
	...
	public String getTitle() {
		return langBundle.getString(this.getClass().getSimpleName() + "Title");
	}
	...
	protected Button makeExitButton() {
		Button b = ButtonFactory.makeButton(ButtonType.TEXT, langBundle.getString("exit"), "exit",
	...
	protected void changeScene(View viewClass) {
		...
		myStage.setMaximized(maximize);
	}

	protected String getLanguageResource(String s) {
		return langBundle.getString(getClass().getSimpleName() + s);
	}
