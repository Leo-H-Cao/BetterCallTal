...
public class GameEditorView extends View {
	...
	private void createDefaultPieces() {
		// Rook
		myController.getPiecesState().createCustomPiece(5, 0, new Image("images/pieces/black/rook.png"), new EditorPiece("PieceID"), "Rook");
		myController.getPiecesState().createCustomPiece(5, 1, new Image("images/pieces/black/rook.png"), new EditorPiece("PieceID"),  "Rook");
	}
}